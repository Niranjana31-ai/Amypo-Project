...
const css = `
  ...
  .login-dash-dot { width: 8px; height: 8px; border-radius: 50%; }
  .login-dash-body {
    display: flex;
  }
  ...
  .login-footer-sep { color: rgba(80,110,200,0.4); font-size: 11px; }
  ...
  .lf-label {
    ...
    color: rgba(170,185,220,0.9); margin-bottom: 7px;
  }
  ...
  .lf-icon-right:hover { color: rgba(130,160,255,1); }
  .lf-input {
    width: 100%;
  ...
  .lf-input::placeholder { color: rgba(100,120,170,0.6); }
  .lf-input:focus {
  ...
  .lf-checkbox {
    ...
    background: linear-gradient(135deg,#4a6aff,#6a8aff);
    border: 1px solid rgba(100,140,255,0.5);
    display: flex; align-items: center; justify-content: center;
    flex-shrink: 0;
    box-shadow: 0 0 10px rgba(70,110,255,0.35);
  }
  .lf-remember-text {
    font-size: 12.5px; color: rgba(160,180,220,0.85); font-weight: 500;
    user-select: none;
  }
  .lf-forgot {
    font-size: 12.5px; color: #5a90ff; font-weight: 500; cursor: pointer;
    background: none; border: none; font-family: inherit;
    transition: color 150ms ease;
  }
  .lf-forgot:hover { color: #7ab0ff; }
  ...
  .lf-divider-line { flex: 1; height: 1px; background: rgba(70,100,200,0.18); }
  .lf-divider-text {
  ...
  .lf-register a:hover { color: #7ab0ff; }
  ...
  @media (max-width: 960px) {
    ...
    .login-right { flex: 1; padding: 24px 20px; }
...
const DashboardMockup = () => (
  <div className="login-dash-card">
    ...
    <div className="login-dash-topbar">
      ...
      <div className="login-dash-dots">
        <div className="login-dash-dot" style={{ background: '#ef4444' }} />
        <div className="login-dash-dot" style={{ background: '#f59e0b' }} />
        <div className="login-dash-dot" style={{ background: '#10b981' }} />
      </div>
    </div>

    <div className="login-dash-body">
      {/* sidebar */}
      <div className="login-dash-sidebar">
        {[
          ...
          <div key={label} className={`login-dash-nav-item${active ? ' active' : ''}`}>
            <div className={`login-dash-nav-dot${active ? ' active-dot' : ''}`}
      ...
      {/* main */}
      <div className="login-dash-content">
        <div className="login-dash-title">Project Overview</div>
        <div className="login-dash-project-name">Website Redesign</div>
        <div className="login-dash-progress-track">
          <div className="login-dash-progress-fill" />
          <span className="login-dash-progress-pct">72%</span>
        </div>
        {[
          ...
          <div className="login-dash-task-row" key={label}>
            <div className="login-dash-task-dot" style={{ background: color }} />
            <span className="login-dash-task-label">{label}</span>
          </div>
        ))}
      </div>
      ...
      <div className="login-dash-stats">
        <div className="login-dash-stat-box">
          <div className="login-dash-stat-num">12</div>
          <div className="login-dash-stat-label">Total Tasks</div>
        </div>
        <div className="login-dash-stat-box">
          <div className="login-dash-stat-num">4</div>
          <div className="login-dash-stat-label">Team Members</div>
        </div>
        <div className="login-dash-badge">On Track</div>
        {/* tiny sparkline */}
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await dispatch(login({ username: formData.username, password: formData.password }));
      ...
      <div className="login-root">
        ...
        <div className="login-left">
          ...
          <div className="login-logo-row">
            <Logo size={26} />
            <span className="login-logo-name">SyncUp</span>
          </div>

          {/* Headline */}
          <h1 className="login-headline">One team. One workspace.</h1>
          <h1 className="login-headline-blue">One direction.</h1>
          ...
          <div className="login-footer">
            {[
              ...
              <React.Fragment key={label}>
                ...
                {i < 3 && <span className="login-footer-sep">•</span>}
              </React.Fragment>
            ))}
          </div>
        </div>
        ...
        <div className="login-right">
          ...
          <div className="login-card">
            ...
            <div className="login-card-logo-row">
              <Logo size={22} />
              <span className="login-card-logo-name">SyncUp</span>
            </div>

            <h2 className="login-card-heading">Welcome back 👋</h2>
            <p className="login-card-sub">Sign in to continue to your SyncUp workspace.</p>

            {/* Error */}
            {localError && (
              <div className="lf-error">
                {Ico.warn}
                {localError.message || 'Invalid credentials. Please try again.'}
              </div>
            )}

            <form onSubmit={handleSubmit}>
              {/* Username (displayed as "Email" to match reference) */}
              <div className="lf-group">
                <label className="lf-label">Email</label>
                <div className="lf-input-wrap">
                  <span className="lf-icon-left">{Ico.user}</span>
                  <input
                    className="lf-input"
                    type="text"
                    name="username"
              ...
              <div className="lf-group">
                ...
                <div className="lf-input-wrap">
                  <span className="lf-icon-left">{Ico.lock}</span>
                  <input
                    className="lf-input"
                  ...
                  />
                  <button type="button" className="lf-icon-right" onClick={() => setShowPw(p => !p)} tabIndex={-1}>
              ...
              <div className="lf-row">
                <label className="lf-remember">
                  <div className="lf-checkbox">{Ico.checkTiny}</div>
                  <span className="lf-remember-text">Remember me</span>
                </label>
            ...
            <div className="lf-divider">
              ...
              <span className="lf-divider-text">Your work matters</span>
              <div className="lf-divider-line" />
            </div>
